  ...
  return (
    <div className="space-y-4 rounded-[1.75rem] border border-white/10 bg-white/[0.04] px-5 py-5">
      <div className="space-y-1">
        <div className="text-[0.72rem] uppercase tracking-[0.2em] text-cyan-200/70">Approval gate</div>
        <h3 className="text-lg font-semibold text-white">Human decision required</h3>
      </div>
      <textarea
        value={notes}
