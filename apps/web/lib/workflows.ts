...
const catalog: Record<Locale, WorkflowPresentation[]> = {
  en: [
    ...
    },
    {
      ...
      targetSecondaryLabel: "Knowledge pack",
      targetSecondaryPlaceholder: "Select a reusable pack from Settings",
  ...
  tr: [
    ...
    },
    {
      ...
      targetSecondaryLabel: "Bilgi paketi",
      targetSecondaryPlaceholder: "Settings içinden reusable pack seç",
