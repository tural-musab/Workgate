      ...
      <div className="grid w-full max-w-5xl gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <section className="space-y-6 rounded-[2.4rem] border border-white/10 bg-white/[0.04] px-8 py-10">
          ...
          <div className="space-y-3">
            <h1 className="max-w-xl text-5xl font-semibold tracking-[-0.06em] text-white">Single-pane control for your AI software office</h1>
          ...
          <div className="grid gap-4 text-sm leading-6 text-slate-300 sm:grid-cols-2">
            <div className="rounded-[1.5rem] border border-white/10 bg-slate-950/30 px-5 py-5">Fixed pipeline across routing, planning, engineering, review, and docs.</div>
            <div className="rounded-[1.5rem] border border-white/10 bg-slate-950/30 px-5 py-5">GitHub writes are blocked until the operator explicitly approves the run.</div>
          </div>
        </section>
        <LoginForm />
      </div>
